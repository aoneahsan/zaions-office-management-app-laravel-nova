<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="cnic" class="block mt-1 w-full" type="text" name="cnic" :value="old('cnic')"
                required autofocus autocomplete="cnic" />
        ...
        <div class="mt-4">
            ...
            <select name="type" autofocus required autocomplete="type" id="type"
