...
class LinkInBio extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\ZLink\LinkInBios\LinkInBio>
     */
    public static $model = \App\Models\ZLink\LinkInBios\LinkInBio::class;
