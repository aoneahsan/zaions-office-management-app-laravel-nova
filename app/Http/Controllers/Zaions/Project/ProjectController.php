...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'completedRecently' => 'nullable|string',
            'inProgress' => 'nullable|string',
            'plannedNext' => 'nullable|string',
        ...
        try {
            $result = Project::create([
                ...
                'featureRequests' => $request->has('featureRequests') ? $request->featureRequests : null,
                'completedRecently' => $request->has('completedRecently') ? $request->completedRecently : null,
                'inProgress' => $request->has('inProgress') ? $request->inProgress : null,
                'plannedNext' => $request->has('plannedNext') ? $request->plannedNext : null,
        ...
        try {
            ...
            if ($item) {
                $item->update([
                    ...
                    'featureRequests' => $request->has('featureRequests') ? $request->featureRequests : $item->featureRequests,
                    'completedRecently' => $request->has('completedRecently') ? $request->completedRecently : $item->completedRecently,
                    'inProgress' => $request->has('inProgress') ? $request->inProgress : $item->inProgress,
                    'plannedNext' => $request->has('plannedNext') ? $request->plannedNext : $item->plannedNext,
